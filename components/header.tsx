      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          >
            ...
            <span className="text-xl font-semibold text-white drop-shadow-lg">MuséesFR</span>
          </Link>
          ...
          <nav className="hidden md:flex items-center space-x-1" role="navigation" aria-label="Navigation principale">
            <Link
              href="/"
              className="text-white drop-shadow-lg hover:text-blue-300 px-3 py-2 rounded-lg hover:bg-white/10 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
            >
              Accueil
            </Link>
            <Link
          ...
          <div className="hidden md:flex items-center space-x-2">
            ...
            <Button size="sm" className="bg-white/20 backdrop-blur-sm hover:bg-white/30 text-white border border-white/30 shadow-sm hover:shadow-md">
              Connexion
            </Button>
          </div>
          ...
          <Sheet>
            <SheetTrigger asChild>
              <Button
                variant="ghost"
                size="sm"
                className="md:hidden text-white hover:bg-white/10 hover:text-blue-300"
